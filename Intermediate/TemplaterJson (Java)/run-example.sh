...
java -jar target/templater-json.jar beers-template.docx beers-data.json beers-output.docx
...
java -jar target/templater-json.jar benchmark-template.xlsx < benchmark-data.json > benchmark-output.xlsx
